...
export function SlurpInlineAd({ promotion, onHide }: { promotion: SlurpPromotion; onHide: () => void }) {
  return (
    <article className="relative overflow-hidden rounded-xl border border-[var(--noodle-accent)]/35 bg-[var(--slurp-surface)] p-4 shadow-sm">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[0.65rem] font-bold uppercase tracking-[0.14em] text-[var(--noodle-accent)]">Sponsored</p>
