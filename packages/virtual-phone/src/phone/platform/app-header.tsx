...
export function PhoneAppHeader({ title, titleId, closeLabel, onClose }: {
  ...
  return (
    <header className="mb-5 flex min-h-11 items-center justify-between gap-3">
      <button type="button" aria-label="Back" onClick={onBack} className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--vp-accent)]"><ArrowLeft size="1rem" aria-hidden="true" /></button>
