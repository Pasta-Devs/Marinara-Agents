...
import { isNoodlerHiddenFromViewer } from "./noodler-access.js";

export function normalizeNoodlerSeenAt(
 ...
 */
export function noodlerUnseenCreatorAccountIds(
  ...
  return accounts
    .filter(
      (account) =>
        account.noodleAccountId !== viewerAccountId &&
