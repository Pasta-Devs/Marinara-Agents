// Beholder 1.3.0 — Marinara Engine roleplay-toolbar capability (single-file client bundle)
...
BH.syncToggles = function syncToggles() {
  ...
  for (const button of document.querySelectorAll(".bh-hud-toggle")) {
