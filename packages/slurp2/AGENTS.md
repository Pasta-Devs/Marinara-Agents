...
6. While the modular refactor is open, update `SLURP-MODULE-STATUS.md` at the repository root when
   you start a slice, after each material discovery, and before handoff. `SLURP-MODULE-PLAN.md` is
