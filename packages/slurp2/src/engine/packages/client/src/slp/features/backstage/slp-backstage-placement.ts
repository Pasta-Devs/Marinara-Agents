...
const place = (
  ...
  scope: SlpBackstageScope,
  ...searchTerms: string[]
): SlpBackstagePlacement => ({ section: slpBackstageSectionFor(section, target), target, scope, searchTerms });
...
export const SLP_BACKSTAGE_SETTING_PLACEMENT: Record<keyof SlurpSettings, SlpBackstagePlacement> = {
  ...
  arcFanReactions: content("storylines", "storyline", "plan fan reactions"),
  arcAutoMode: content("storylines", "storyline", "automatic plans", "story suggestions"),
  arcCooldownWeeks: content("storylines", "storyline", "plan cooldown"),
  arcSource: content("storylines", "storyline", "plan source", "generated stories"),
  arcMaxConcurrentAuto: content("storylines", "storyline", "concurrent plans"),
  arcDirectorMode: content("storylines", "storyline", "plan director"),
  arcPollHours: content("storylines", "storyline", "plan polling"),
  arcStatEffects: content("storylines", "storyline", "plan stat effects"),
  arcCrossovers: content("storylines", "storyline", "plan crossovers"),
  ...
  carryoverModes: place("models", "connections", "all-slurp", "carryover", "Engine chats"),
  carryoverHours: place("models", "connections", "all-slurp", "carryover hours"),
  carryoverMaxItems: place("models", "connections", "all-slurp", "carryover limit"),
