...
const noodlerFanArchetypeWeightsObjectSchema = z
    ...
    .strict();
export const noodlerFanArchetypeWeightsSchema = noodlerFanArchetypeWeightsObjectSchema.refine((weights) => Object.values(weights).some((weight) => weight > 0), {
...
export const noodleSettingsSchema = z.object({
    ...
    participantSelectionMode: noodleParticipantSelectionModeSchema.default(DEFAULT_NOODLE_SETTINGS.participantSelectionMode),
...
function boundedGeneratedProfileText(maxLength, minimumLength = 0) {
    return z
        .string()
        .transform((value) => {
...
//# sourceMappingURL=noodle.schema.js.map