...
| Long-Term Memory | [`long-term-memory`](packages/long-term-memory/manifest.json) | Captures finalized turns and recalls relevant context from a durable local memory vault. |
