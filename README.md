...
| World Maps | [`hierarchical-maps`](packages/hierarchical-maps/manifest.json) | Adds persistent nested locations, shared template artwork, spatial context, map authoring, and movement. |
