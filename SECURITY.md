...
- scans JavaScript, TypeScript, and GitHub Actions with CodeQL's security-and-quality queries, audits dependencies at every advisory severity, and sends bounded dependency updates to `staging`; and
