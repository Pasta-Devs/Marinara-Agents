...
- Treat `packages/**/client.js`, `packages/**/server.mjs`, `artifacts/*.zip`, file hashes, checksums, and catalog sizes as generated outputs. Change their source or build scripts, then rebuild them; do not hand-edit generated bundles or hashes.
