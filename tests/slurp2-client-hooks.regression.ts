...
const CALLS_BEFORE = [
  "delete /slurp2/slurp/accounts/${encodeURIComponent(accountId)}",
  "delete /slurp2/slurp/accounts/${encodeURIComponent(accountId)}/avatar",
  "delete /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/projects/${encodeURIComponent(projectId)}?personaId=${encodeURIComponent(personaId)}",
  "delete /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/subscribe?personaId=${encodeURIComponent(personaId)}",
  "delete /slurp2/slurp/ads/pool/${encodeURIComponent(promotionId)}",
  "delete /slurp2/slurp/posts/${encodeURIComponent(id)}?accountId=${encodeURIComponent(accountId)}",
  "delete /slurp2/slurp/posts/${encodeURIComponent(postId)}/interactions/${encodeURIComponent(interactionId)}?personaId=${encodeURIComponent(personaId)}",
  "delete /slurp2/slurp/posts/${encodeURIComponent(postId)}/interactions?${params}",
  ...
  "get /slurp2/slurp/account-connection-counts",
  "get /slurp2/slurp/accounts",
  "get /slurp2/slurp/accounts/${encodeURIComponent(accountId!)}/posts?${query.toString()}",
  "get /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId!)}/arc-config?personaId=${encodeURIComponent(personaId!)}",
  "get /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId!)}/arcs?personaId=${encodeURIComponent(personaId!)}",
  "get /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId!)}/projects?personaId=${encodeURIComponent(personaId!)}",
  "get /slurp2/slurp/ads/pool",
  "get /slurp2/slurp/audience/${encodeURIComponent(memberId!)}?creatorAccountId=${encodeURIComponent(creatorAccountId ?? ",
  "get /slurp2/slurp/auto-post/status",
  "get /slurp2/slurp/creator-metrics",
  "get /slurp2/slurp/image-connections",
  "get /slurp2/slurp/post-guidance",
  "get /slurp2/slurp/viewer-wallets",
  "get /slurp2/slurp/viewer/ads?personaId=${encodeURIComponent(personaId!)}${creatorId ? ",
  "get /slurp2/slurp/viewer/unseen-count?personaId=${encodeURIComponent(personaId!)}",
  "get /slurp2/slurp/viewer/wallet?personaId=${encodeURIComponent(personaId!)}",
  ...
  "patch /slurp2/slurp/accounts/${encodeURIComponent(accountId)}/avatar/source",
  "patch /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/follow",
  "patch /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/projects/${encodeURIComponent(projectId)}",
  "patch /slurp2/slurp/ads/pool/${encodeURIComponent(id)}",
  "patch /slurp2/slurp/auto-post/schedule/${encodeURIComponent(slotId)}",
  "patch /slurp2/slurp/image-connections",
  "patch /slurp2/slurp/image-connections",
  "patch /slurp2/slurp/post-guidance",
  "patch /slurp2/slurp/posts/${encodeURIComponent(id)}",
  "patch /slurp2/slurp/posts/${encodeURIComponent(postId)}/interactions/${encodeURIComponent(interactionId)}",
  ...
  "post /slurp2/slurp/accounts/${encodeURIComponent(accountId)}/artwork/generate",
  "post /slurp2/slurp/accounts/${encodeURIComponent(accountId)}/auto-post/run-now",
  "post /slurp2/slurp/accounts/${encodeURIComponent(accountId)}/source/${action}",
  "post /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/arc-library/generate",
  "post /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/payout",
  "post /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/projects",
  "post /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/projects/${encodeURIComponent(projectId)}/director",
  "post /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/projects/${encodeURIComponent(projectId)}/library",
  "post /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/projects/${encodeURIComponent(projectId)}/profile",
  "post /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/projects/generate",
  "post /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/subscribe",
  "post /slurp2/slurp/accounts/${encodeURIComponent(input.accountId)}/tip",
  "post /slurp2/slurp/ads/${encodeURIComponent(promotionId)}/image",
  "post /slurp2/slurp/ads/lorebook/sync",
  "post /slurp2/slurp/ads/pool",
  "post /slurp2/slurp/auto-post/refresh-targeted",
  "post /slurp2/slurp/first-posts/enqueue",
  "post /slurp2/slurp/notifications/seen",
  "post /slurp2/slurp/post-guidance-draft",
  "post /slurp2/slurp/posts/${encodeURIComponent(id)}/image/generate",
  "post /slurp2/slurp/posts/${encodeURIComponent(postId)}/interactions",
  "post /slurp2/slurp/posts/${encodeURIComponent(postId)}/interactions/${encodeURIComponent(interactionId)}/creator-reply",
  "post /slurp2/slurp/posts/${encodeURIComponent(postId)}/unlock",
  "post /slurp2/slurp/refresh/images",
  "post /slurp2/slurp/viewer/ads/${encodeURIComponent(promotionId)}/action",
  "post /slurp2/slurp/viewer/ads/${encodeURIComponent(promotionId)}/hide",
  "post /slurp2/slurp/viewer/ads/brand/hide",
  "post /slurp2/slurp/viewer/ads/brand/unhide",
  "post /slurp2/slurp/viewer/ads/reset",
  "post /slurp2/slurp/viewer/mark-seen",
  "post /slurp2/slurp/viewer/wallet/daily-refill",
  "post /slurp2/slurp/viewer/wallet/dev-set",
  "put /slurp2/slurp/accounts/${encodeURIComponent(accountId)}/stage-profile",
  "put /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/arc-config",
  "put /slurp2/slurp/accounts/${encodeURIComponent(creatorAccountId)}/goal",
  "put /slurp2/slurp/accounts/${encodeURIComponent(input.accountId)}/subscription-price",
  ...
  "upload /slurp2/slurp/accounts/${encodeURIComponent(accountId)}/avatar",
  "upload /slurp2/slurp/accounts/${encodeURIComponent(accountId)}/banner",
  "upload /slurp2/slurp/posts/${encodeURIComponent(id)}/media",
];
const calls = [
  ...
  .map((m) => `${m[1]} ${m[2]}`)
  .sort();
assert.deepEqual(calls, [...CALLS_BEFORE].sort(), "client request paths and HTTP methods must match");
