...
assert.deepEqual(
  ...
  ["0.0.28", "0.0.27", "0.0.26", "0.0.25", "0.0.24", "0.0.22", "0.0.21", "0.0.20", "0.0.19", "0.0.18", "0.0.17"],
  "an update from 0.0.16 must show the Backstage release",
);
assert.deepEqual(
  getSlurp2UnseenReleases("0.0.17").map((release) => release.version),
  ["0.0.28", "0.0.27", "0.0.26", "0.0.25", "0.0.24", "0.0.22", "0.0.21", "0.0.20", "0.0.19", "0.0.18"],
...
assert.deepEqual(
  ...
  ["0.0.28", "0.0.27", "0.0.26", "0.0.25", "0.0.24", "0.0.22", "0.0.21", "0.0.20", "0.0.19"],
...
assert.deepEqual(
  ...
  ["0.0.28", "0.0.27", "0.0.26", "0.0.25", "0.0.24", "0.0.22", "0.0.21", "0.0.20"],
...
assert.deepEqual(getSlurp2UnseenReleases("0.0.28"), [], "the current release must not reopen an acknowledged splash");
