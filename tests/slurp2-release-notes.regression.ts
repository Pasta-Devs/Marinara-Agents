...
assert.equal(SLURP2_VERSION, "0.2.1");
...
assert.deepEqual(
  ...
  ["0.2.1", "0.2.0", "0.1.3", "0.1.2", "0.1.1", "0.1.0", "0.0.22"],
);
assert.deepEqual(
...
assert.deepEqual(getSlurp2UnseenReleases("0.2.1"), []);
