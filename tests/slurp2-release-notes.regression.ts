...
assert.deepEqual(
  ...
  ["0.0.12", "0.0.11", "0.0.10", "0.0.9", "0.0.8", "0.0.7", "0.0.6", "0.0.5"],
...
assert.deepEqual(getSlurp2UnseenReleases("0.0.12"), [], "the current release must not reopen an acknowledged splash");
