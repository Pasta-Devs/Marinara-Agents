...
assert.deepEqual(
  ...
  ["0.0.9"],
  "an update from 0.0.8 must show the Autopurge release",
);
assert.deepEqual(getSlurp2UnseenReleases("0.0.9"), [], "the current release must not reopen an acknowledged splash");
