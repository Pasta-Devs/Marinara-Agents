...
assert.match(vault, /grid-cols-\[auto_minmax\(0,1fr\)\]/u);
assert.match(vault, /row-span-2 shrink-0 transition-transform/u);
...
assert.match(vault, /bg-\[var\(--marinara-editor-control-bg\)\]/u);
...
assert.match(vault, /group-open:rotate-90/u);
