...
const view = readFileSync(
  "packages/noodle/src/engine/packages/client/src/components/noodle/NoodleView.tsx",
  "utf8",
);
const entry = readFileSync(
  "packages/noodle/src/engine/packages/server/src/services/noodle/server-entry.ts",
  "utf8",
);
