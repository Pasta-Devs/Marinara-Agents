...
function WorkspaceOverlay({ chatId, onClose }) { return createPortal(<div data-marinara-maps-workspace-overlay className="fixed inset-0 isolate z-[10020] overflow-hidden bg-[var(--background)]"><SpatialMapWorkspace chatId={chatId} onClose={onClose} /><Toaster richColors /></div>, document.body); }
